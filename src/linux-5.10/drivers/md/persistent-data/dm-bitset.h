 ...
 * info - describes the bitset
 * root - the root block of the bitset
 * index - the bits start index
 * bits - bitmap indicates which bit should be set, NULL means set up to nr_bits
 * nr_bits - bitmap size of *bits
 * new_root - on success, points to the new root block
 *
 * -ENODATA will be returned if the index is out of bounds.
 */
 ...
 * root - the root block of the bitset
 * index - the bits start index
 * bits - bitmap indicates which bit should be cleared, NULL means clear up to nr_bits
 * nr_bits - bitmap size of *bits
 * new_root - on success, points to the new root block
 *
 * -ENODATA will be returned if the index is out of bounds.
