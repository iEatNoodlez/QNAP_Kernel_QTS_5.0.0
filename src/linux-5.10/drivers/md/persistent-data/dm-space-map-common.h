...
#define DM_SM_METADATA_THIN_MAX_BLOCKS (511 * ((1 << 15) - 64))
#define DM_SM_METADATA_CACHE_MAX_BLOCKS DM_SM_METADATA_MAX_BLOCKS
...
typedef dm_block_t (*max_blocks_fn)(struct ll_disk *ll);
