...
#if defined (CONFIG_MACH_QNE) && defined (CONFIG_MACH_QNAPTS)
#undef CONFIG_MACH_QNAPTS
#endif
...
extern int ha_enabled; /* QNAP_PATCH on 20210107 */
#endif
...
#ifdef CONFIG_MACH_QNAPTS
/* QNAP_PATCH on 20210107 */
#define BM_BLOCK_SHIFT  19                       /* 512k per bit */
#else
...
#ifdef CONFIG_MACH_QNAPTS
/* QNAP_PATCH on 20210107 */
#define BM_EXT_SHIFT    BM_BLOCK_SHIFT+12      /* 2^11 MiB per resync extent */
#else
...
#ifdef CONFIG_MACH_QNAPTS
/* QNAP_PATCH on 20210107 */
#if ((BM_BLOCK_SHIFT != 12) && (BM_BLOCK_SHIFT != 19))
...
#ifdef CONFIG_MACH_QNAPTS
/* QNAP_PATCH on 20210107 */
#define DRBD_MAX_BIO_SIZE_SAFE (1U << 19)       /* Works always = 512k */
#else
