...
#ifdef CONFIG_MACH_QNAPTS
    /* There's a bug in commit ae46f184bc1fb15bf2de47114c29236e61ca4bbc. 
     * If the last slave is not link, this function always return bond_tx_drop. 
     * Revet a part of commit ae46f184. */
