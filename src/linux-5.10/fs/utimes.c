...
static void qnap_get_i_info_with_mtime(struct inode *inode,
		struct timespec64 *i_mtime, T_INODE_INFO *i_info)
{
...
static void qnap_fnotify_utime_notify(const struct path *path, T_INODE_INFO *i_info,
