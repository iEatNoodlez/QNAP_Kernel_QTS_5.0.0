	      ...
	      char *end_buf)
{
    ...
    unsigned char type_11g = 0, type_11b = 1, have_11n = 0, have_11ac = 0, bitrate = 0;
    unsigned char have_11ax = 0;
#endif
	...
	while (rem >= 2) {
        ...
        case WLAN_EID_HT_CAPABILITY:
            have_11n = 1;
            break;
        case WLAN_EID_VHT_CAPABILITY:/*Add to support 80211ac*/
            have_11ac = 1;
            break;
        case WLAN_EID_EXTENSION: /* Add to support 80211ax */
            if(ie[1] < 1) { // extended sub-tag length
                // error: should not reach here
                break;
            }
            if(ie[2] == WLAN_EID_EXT_HE_CAPABILITY) {
                have_11ax = 1;
            }
            break;
...
static int ieee80211_scan_results(struct cfg80211_registered_device *rdev,
				  ...
				  char *buf, size_t len)
{
    // qnap: apply patch for Argument list too long: https://patchwork.kernel.org/patch/11088717/   
