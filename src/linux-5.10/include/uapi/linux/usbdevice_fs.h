 ...
 */
#define USBDEVFS_HUB_PORT_TEST     _IOR('U', 32, struct usbdevfs_hub_portinfo)
#define USBDEVFS_HUB_RESET         _IOR('U', 33, struct usbdevfs_hub_portinfo)
#define USBDEVFS_ASMHUB_FW_UPDATE   _IOWR('U', 34, struct usbdevfs_ioctl)
#endif
/*
