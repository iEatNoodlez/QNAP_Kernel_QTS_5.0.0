...
#define NFS4_VSTORAGE_PRIM_CLONEFILE        0x0001
#define NFS4_VSTORAGE_PRIM_RESVSPACE        0x0002
#define NFS4_VSTORAGE_PRIM_STATX            0x0004

enum nfs4_vstorageop {
        NFS4_VSTORAGEOP_REGISTER = 0,
        NFS4_VSTORAGEOP_RESERVESPACE = 1,
        NFS4_VSTORAGEOP_EXTENDEDSTAT = 2,
        NFS4_VSTORAGEOP_CLONEFILE = 3,
		NFS4_VSTORAGEOP_INQUIRY = 4,
		NFS4_VSTORAGEOP_TASKABORT = 5
};
