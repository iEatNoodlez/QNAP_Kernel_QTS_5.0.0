...
struct sbc_ops {
	...
	sense_reason_t (*execute_qnap_get_lba_status)(struct se_cmd *cmd);

	/* match for (*execute_unmap) */
	sense_reason_t (*execute_qnap_unmap)(struct se_cmd *cmd,
				sector_t lba, sector_t nolb);

	sense_reason_t (*execute_qnap_ws_fast_zero)(struct se_cmd *cmd);
	bool (*execute_qnap_ws_is_zero_buf)(struct se_cmd *cmd);
#endif
};
