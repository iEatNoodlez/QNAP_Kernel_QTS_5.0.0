...
include/uapi/linux/usbdevice_fs.h:CONFIG_MACH_QNAPTS
include/uapi/linux/reboot.h:CONFIG_MACH_QNAPTS
include/uapi/asm-generic/unistd.h:CONFIG_MACH_QNAPTS
include/uapi/asm-generic/unistd.h:CONFIG_ARM64
"
