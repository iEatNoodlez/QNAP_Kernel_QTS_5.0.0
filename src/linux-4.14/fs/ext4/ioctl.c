...
resizefs_out:
	...
	case EXT4_IOC_GETLAZYINITSTATUS:
	{
		...
		return put_user(sbi->s_lazyinit_status, (int __user *) arg);
	}
...
out:
	...
	case EXT4_IOC_GETTRIMSTATUS:
	{
		struct ext4_sb_info *sbi = EXT4_SB(sb);

		return put_user(sbi->s_reclaim_status, (int __user *) arg);
	}
...
long ext4_compat_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case EXT4_IOC_TRIMASYNC:
		break;
	case EXT4_IOC32_GETTRIMSTATUS:
		cmd = EXT4_IOC_GETTRIMSTATUS;
		break;
	case EXT4_IOC_SHUTDOWN:
	case FS_IOC_GETFSMAP:
		break;
