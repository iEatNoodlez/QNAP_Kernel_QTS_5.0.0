...
#define EXT4_GET_BLOCKS_PUT_HOT_ANCHOR      0x0800
#define EXT4_GET_BLOCKS_PUT_COLD_ANCHOR     0x1000
#define EXT4_GET_BLOCKS_CLEAR_ANCHOR        0x2000
...
#define EXT4_IOC32_GETTRIMSTATUS	FS_IOC32_GETTRIMSTATUS
#define EXT4_IOC_GETTRIMSTATUS		FS_IOC_GETTRIMSTATUS
#define EXT4_IOC_TRIMASYNC		FS_IOC_TRIMASYNC
...
#define EXT4_MOUNT_RICH_ACL             0x2000000 /* RICH Access Control Lists */
#endif
...
#define EXT4_MF_FAKE_READONLY           0x0008 /* fake readonly */
...
struct ext4_sb_info {
	...
	/* lazyinit status */
	int s_lazyinit_status;

	/* QNAP customized trim */
	struct ext4_trim_request *s_trim_request;
	struct mutex s_trim_mtx;
	struct task_struct *s_trim_task;
	int s_reclaim_status;

	/* QNAP forced trim hint */
	int s_forced_trim;
...
extern void ext4_io_submit_init(struct ext4_io_submit *io,
				struct writeback_control *wbc, int hint);
