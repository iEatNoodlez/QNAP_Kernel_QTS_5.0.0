...
#ifdef CONFIG_MACH_QNAPTS
	TRANSPORT_WORK_THREAD_PROCESS = 100,
#endif
};
...
#define R(x)	(__force sense_reason_t )(x)
	...
	TCM_LOGICAL_BLOCK_REF_TAG_CHECK_FAILED	= R(0x17), // kernel 4.2.8 end here
...
#define CMD_T_PRE_EXECUTE	(1 << 12)
	...
	struct zmc_data		zmc_data;
#endif
#ifdef QNAP_TARGET_PERF_FEATURE
	bool			run_complete_ok_directly; /* the default is false */
#endif
#endif
	uint64_t		b_se_state;
	uint64_t		b_se_state_last;
	unsigned long 		start_jiffies;
	unsigned long 		complete_jiffies;
};

#define BS_SE_CMD_INIT			0x0000000000000001
#define BS_SE_CMD_GET_SESS		0x0000000000000002
#define BS_SE_CMD_PUT_SESS		0x0000000000000004
#define BS_SE_CMD_SET_CMD_CDB		0x0000000000000008
#define BS_SE_CMD_EXEC_WT_CMD		0x0000000000000010
#define BS_SE_CMD_ADD_TO_Q		0x0000000000000020
#define BS_SE_CMD_EXEC_CMD		0x0000000000000040
#define BS_SE_CMD_EXEC_CMD_2		0x0000000000000080
#define BS_SE_CMD_EXEC_COMPLETE		0x0000000000000100
#define BS_SE_CMD_FD_EXEC_RW		0x0000000000000200
#define BS_SE_CMD_FD_DO_RW		0x0000000000000400
#define BS_SE_CMD_FD_DO_RW_RETURN	0x0000000000000800
#define BS_SE_CMD_SBC_DIF_VERIFY	0x0000000000001000
#define BS_SE_CMD_VFS_ITER_RW		0x0000000000002000
#define BS_SE_CMD_VFS_ITER_RW_DONE	0x0000000000004000
#define BS_SE_CMD_FD_EXEC_SYNC		0x0000000000008000
#define BS_SE_CMD_FD_EXEC_WRITE_SAME	0x0000000000010000
#define BS_SE_CMD_FD_EXEC_UNMAP		0x0000000000020000
#define BS_SE_CMD_BLK_EXEC_RW		0x0000000000040000
#define BS_SE_CMD_BLK_BIO_PREPARE	0x0000000000080000
#define BS_SE_CMD_BLK_BIO_SUBMIT	0x0000000000100000
#define BS_SE_CMD_BLK_BIO_RETURN	0x0000000000200000
#define BS_SE_CMD_BLK_BIO_COMPLETE	0x0000000000400000
#define BS_SE_CMD_BLK_SYNC_CACHE	0x0000000000800000
#define BS_SE_CMD_BLK_WRITE_SAME	0x0000000001000000
#define BS_SE_CMD_BLK_UNMAP		0x0000000002000000
#define BS_SE_CMD_FD_EXEC_UNMAP_DONE	0x0000000004000000
#define BS_SE_CMD_BLK_UNMAP_DONE	0x0000000008000000
#define BS_SE_CMD_Q_TO_COMP_WORK	0x0000000010000000
#define BS_SE_CMD_COMP_OK_WORK		0x0000000020000000
#define BS_SE_CMD_COMP_FAILURE_WORK	0x0000000040000000
#define BS_SE_CMD_PREP_REALLIGANCE	0x0000000080000000
#define BS_SE_CMD_ABORT_BY_TMC		0x0000000100000000
#define BS_SE_CMD_FREE			0x0000000200000000
#define BS_SE_CMD_FREE_1		0x0000000400000000
#define BS_SE_CMD_FREE_2		0x0000000800000000
...
struct se_tpg_redirect {
	struct se_portal_group *tpg_redirect_parent;
	struct config_group tpg_redirect_group;
};
#endif
