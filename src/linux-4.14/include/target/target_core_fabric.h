...
struct target_core_fabric_ops {
	...
	void (*set_delay_remove)(struct se_cmd *, bool);
	u32 (*get_task_tag)(struct se_cmd *);
	struct sockaddr_storage *(*get_login_ip)(struct se_cmd *);
	...
	int (*fabric_set_redirect_algo)(struct se_portal_group *, const u8);
	void (*fabric_get_redirect_algo)(struct se_portal_group *, char **);
	struct se_tpg_redirect *(*fabric_make_redirect)(struct se_portal_group *,
			struct config_group *, const char *);
	void (*fabric_drop_redirect)(struct se_tpg_redirect *, const char *);
	struct configfs_attribute **tfc_tpg_redirect_base_attrs;
#endif
#endif
};
