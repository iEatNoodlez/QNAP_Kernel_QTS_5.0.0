...
enum iscsi_login_redirect_algo_table {
	ISCSI_LOGIN_REDIRECT_ALGO_NONE = 0,
	ISCSI_LOGIN_REDIRECT_ALGO_RR   = 1,
};
#endif
#endif
...
#define ISCSI_SENSE_BUFFER_LEN          (TRANSPORT_SENSE_BUFFER + 2)
	...
	void			*obj2cmd_node;
	struct iscsit_zmc_cmd_ops	*zmc_cmd_ops;
...
#define BS_ALLOCATE_ISCSI_CMD		0x000000001
#define BS_ALLOCATE_ISCSI_IOVECS	0x000000002
#define BS_ADD_ISCSI_REJECT		0x000000004
#define BS_SETUP_ISCSI_CMD		0x000000008
#define BS_GET_ISCSI_SE_CMD		0x000000010
#define BS_PROCESS_SCSI_CMD		0x000000020
#define BS_ADD_ISCSI_CMD_TO_LIST	0x000000040
#define BS_HANDLE_ISCSI_IMMED_DATA	0x000000080
#define BS_EXEC_ISCSI_CMD		0x000000100
#define BS_ADD_ISCSI_CMD_TO_RSP_Q	0x000000200
#define BS_BUILD_ISCSI_PDU_SEQ		0x000000400
#define BS_HANDLE_ISCSI_DATA_OUT	0x000000800
#define BS_SETUP_ISCSI_NOP_OUT		0x000001000
#define BS_HANDLE_ISCSI_TMC		0x000002000
#define BS_SETUP_ISCSI_TEXT_CMD		0x000004000
#define BS_PROC_ISCSI_TEXT_CMD		0x000008000
#define BS_SEQ_ISCSI_CMD		0x000010000
#define BS_HANLE_ISCSI_IMMED_QUEUE	0x000020000
#define BS_HANLE_ISCSI_RESP_QUEUE	0x000040000
...
struct iscsi_conn {
	...
	struct zmc_work_data		*zmc_dr;
	struct iscsit_zmc_conn_ops	*zmc_conn_ops;
#endif
#endif
...
#define MAX_REDIRECT_IPPORT_LEN		256
struct iscsi_redirect {
	bool			enable;
	bool			algo_rr_picked;
	char			ip[IPV6_ADDRESS_SPACE];
	u16			port;
	/* one of ISCSI_STATUS_TGT_MOVED_* constants */
	u8			type;
	unsigned long		cnt;
	struct list_head	redirect_list;
};

struct iscsi_tpg_redirect {
	u8			algo;
	struct list_head	tpg_redirect_list;
};
...
#if defined(CONFIG_MACH_QNAPTS) && defined(ISCSI_LOGIN_REDIRECT)
	struct iscsi_tpg_redirect tpg_redirect;
#endif
} ____cacheline_aligned;
