...
#define IF_MACH_QNAPTS(flag,string) ,{1UL << flag, string}
#else
#define IF_MACH_QNAPTS(flag,string)
#endif
...
IF_MACH_QNAPTS(PG_wb_account,		"wb_account"	)		\
IF_MACH_QNAPTS(PG_lru_anchored,		"lru_anchored"	)		\
IF_MACH_QNAPTS(PG_dirty_count,		"dirty_count"	)
