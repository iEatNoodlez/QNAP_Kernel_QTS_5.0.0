...
#if defined(CONFIG_MACH_QNAPTS) && defined(CONFIG_QND_ZX_PATCH)
	[AZX_DRIVER_ZX] = "HDA ZX HDA",
	[AZX_DRIVER_ZXHDMI] = "HDA ZX HDMI",
#endif
...
static int azx_init_pci_zx(struct azx *chip)
{
	...
	diu_pci = pci_get_device(0x1d17, 0x3a03, NULL); // just for chx001
	if(!diu_pci) {
		dev_err(card->dev, "zx_hda no chx001 device. \n");
		return -ENXIO;
	}
...
static const struct pci_device_id azx_ids[] = {
	...
	/* ZHAOXIN */
	{ PCI_DEVICE(0x1d17, 0x9142), .driver_data = AZX_DRIVER_ZXHDMI | AZX_DCAPS_POSFIX_LPIB | AZX_DCAPS_NO_MSI | AZX_DCAPS_RIRB_PRE_DELAY },
	{ PCI_DEVICE(0x1d17, 0x9144), .driver_data = AZX_DRIVER_ZXHDMI | AZX_DCAPS_POSFIX_LPIB | AZX_DCAPS_NO_MSI | AZX_DCAPS_RIRB_PRE_DELAY },
#endif
	/* SIS966 */
