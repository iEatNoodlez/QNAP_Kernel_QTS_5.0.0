 ...
 * Jasper Lake-N (PCH)Lake 0x4da3 32 hard yes yes yes
...
static void i801_add_tco(struct i801_priv *priv)
{
	...
	else if (pci_dev->device == PCI_DEVICE_ID_INTEL_COMETLAKE_H_SMBUS)
		pdev = i801_add_tco_cnl(priv, pci_dev, tco_res);
	else
#endif
	pdev = platform_device_register_resndata(&pci_dev->dev, "iTCO_wdt", -1,
