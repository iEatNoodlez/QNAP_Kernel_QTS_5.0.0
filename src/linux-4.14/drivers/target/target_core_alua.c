...
target_emulate_set_target_port_groups(struct se_cmd *cmd)
{
	...
	/* spc4r37a, p62, p502
	 * A parameter list length of zero specifies that no data shall be
	 * transferred, and that no change shall be made in the target port
	 * asymmetric access state of any target port groups or target ports.
	 * This condition shall not be considered an error, unless otherwise specified.
	 */
	u32 size;
