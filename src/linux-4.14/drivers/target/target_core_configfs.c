...
#include "qnap/target_core_qconfigfs.h"
...
#ifndef CONFIG_MACH_QNAPTS // use QNAP define macro
CONFIGFS_ATTR(, emulate_fua_write);
#endif
#ifdef CONFIG_MACH_QNAPTS
CONFIGFS_ATTR(, qnap_productid);
#endif
CONFIGFS_ATTR(, emulate_fua_read);
#ifndef CONFIG_MACH_QNAPTS // emulate_write_cache becomes read-only
CONFIGFS_ATTR(, emulate_write_cache);
#else
CONFIGFS_ATTR_RO(, emulate_write_cache);
#endif
...
struct configfs_attribute *sbc_attrib_attrs[] = {
	...
	&attr_lun_index,
#ifdef SUPPORT_TP
	&attr_tp_threshold_enable,
	&attr_tp_threshold_percent,
	&attr_allocated,
#endif
#endif
	NULL,
...
static ssize_t target_dev_cluster_api_store(
	void *p,
	const char *page,
	size_t count)
{
...
static ssize_t target_dev_cluster_api_show(void *p, char *page)
{
	struct se_device *dev = p;
...
#if defined(CONFIG_MACH_QNAPTS) && defined(CONFIG_QTS_CEPH)
CONFIGFS_ATTR(target_dev_, cluster_api);
#endif
...
#ifdef CONFIG_MACH_QNAPTS
	&target_dev_attr_provision,
	&target_dev_attr_naa_vendor,
	&target_dev_attr_naa_code,
	&target_dev_attr_qlbs,
	&target_dev_attr_wt,
	&target_dev_attr_zc,
	&target_dev_attr_read_deletable,
#ifdef SUPPORT_FAST_BLOCK_CLONE
	&target_dev_attr_qfbc_supported,
	&target_dev_attr_qfbc_enable,
#endif
#ifdef CONFIG_QTS_CEPH
	&target_dev_attr_cluster_api,
#endif
#endif
	NULL,
};
